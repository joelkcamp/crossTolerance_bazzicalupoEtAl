...
x = getwd()
setwd(x)
setwd("~/Dropbox/ottoLabNotes/cross_tol_data/raw_OD/")
...
folder <- "~/Dropbox/ottoLabNotes/cross_tol_data/raw_OD/"
...
pdf("~/Dropbox/ottoLabNotes/cross_tol_data/figures/growth_curves_recip_trans.pdf", onefile = TRUE)
par(mfrow = c(10,4))
par(mar = c(0,0,0,0))
