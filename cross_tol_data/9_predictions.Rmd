...
ct_orp =cross.tol.combos %>% 
  ggplot(aes(x=ORP,y=ct)) +
    ...
    geom_smooth(method="lm",linetype="dashed",color="black", se=FALSE) +
     theme_minimal() +
    labs(x="Electropotential similarity", y="Metal pairs\nCross-tolerance")+
...
ct_slope =cross.tol.combos %>% 
  ggplot(aes(x=all_slope,y=ct)) +
    ...
    geom_smooth(method="lm",linetype="dashed",color="black", se=FALSE) +
     theme_minimal() +
    labs(x="Metal co-occurrence", y="Metal pairs\nCross-tolerance")+
  theme(axis.text=element_text(size=16),
        axis.title=element_text(size=18))
ct_slope
...
ct_prop =cross.tol.combos %>% 
  ggplot(aes(x=prop.syn,y=ct)) +
    ...
    geom_smooth(method="lm",linetype="dashed",color="black", se=FALSE) +
     theme_minimal() +
    labs(x="Proportion of gene overlap", y="Metal pairs\nCross-tolerance")+
  theme(axis.text=element_text(size=16),
        axis.title=element_text(size=18))
ct_prop
...
orplin=mydata3 %>% 
  ...
  theme(axis.text=element_text(size=14),
    ...
    labs(x="Electropotential similarity", y="Cross-tolerance per evolved line")
...
proplin=mydata3 %>% 
  ...
  theme(axis.text=element_text(size=14),
        axis.title=element_text(size=14,face="bold"))+
    labs(x="Proportion of gene overlap", y="Cross-tolerance per evolved line")
...
usgslin=mydata3 %>% 
  ...
  theme(axis.text=element_text(size=14),
    ...
    labs(x="Metal co-occurrence", y="Cross-tolerance per evolved line")
