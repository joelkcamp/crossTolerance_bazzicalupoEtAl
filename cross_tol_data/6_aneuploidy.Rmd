...
setwd("~/Dropbox/ottoLabNotes/cross_tol_data/depth/10_DepthAnalyses/")
require(stats)
files <-list.files()
#Reorder
...
```{r }
pdf("~/Dropbox/ottoLabNotes/cross_tol_data/figures/coverage_chrom.pdf", onefile = TRUE)
#par(mfrow = c(10,4))
...
write.csv(chr_avg, "~/Dropbox/ottoLabNotes/cross_tol_data/depth/chr_avg.csv")
...
i1 <- read.csv("~/Dropbox/ottoLabNotes/cross_tol_data/depth/whole_chrom_dups.csv")
