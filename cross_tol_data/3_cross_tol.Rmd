...
ggsave("figures/phenotypes1.jpeg", width=14, height=10, units = "in", dpi=700) # figure 2
```

Calulating cross-tolerance between a pair of metals (X and Y) is the average ratio of growth in the non-evolved env’t to the evolved env’t.  That is, cross-tolerance would be:
