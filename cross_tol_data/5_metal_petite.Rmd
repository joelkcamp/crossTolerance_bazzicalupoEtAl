...
library(viridis)
setwd("~/crossTolerance_bazzicalupoEtAl/cross_tol_data/raw_outcross_petite/")

# file with metadata of bioscreen wells
codes <- read.csv("~/crossTolerance_bazzicalupoEtAl/cross_tol_data/raw_outcross_petite/bioscreen20230418BIO1_codes.csv") # 
biosc2 <- read.csv("~/crossTolerance_bazzicalupoEtAl/cross_tol_data/raw_outcross_petite/20230418_BIO2.csv")
...
pdf("~/crossTolerance_bazzicalupoEtAl/cross_tol_data/figures/outcross_petite_metals.pdf", onefile = TRUE)
par(mfrow = c(10,4))
par(mar = c(0,0,0,0))
